...
Run: `cargo test --lib engine::tests::converts_known_gregorian_date`
Expected: PASS. (Reference value verified by compiling the ICU4X spike.)

- [ ] **Step 3: Run the invalid-date test**

Run: `cargo test --lib engine::tests::rejects_invalid_gregorian_date`
Expected: PASS.
...
Run: `cargo test --lib names::tests`
Expected: all 3 PASS.
...
Run: `cargo test --lib render::tests::formats_date_line`
Expected: PASS.
...
Run: `cargo test --lib render::events_list_tests`
Expected: PASS.
...
Run: `cargo test --lib json::tests::serializes_expected_fields`
Expected: PASS.
